...
public class Flight {
    ...
    */
        private Aéroport departure;
        private Aéroport arrival;
        private String airlineName;
        private String airLineCode;
        private int number;
        private LocalDateTime arrivalTime;

    public Aéroport getDeparture() {
        return departure;
    }

    private LocalDateTime departureTime;

    public Aéroport getArrival() {
        return arrival;
    }

    public Flight(Aéroport departure, Aéroport arrival, String airlineName, String airLineCode, int number, LocalDateTime arrivalTime, LocalDateTime departureTime) {
